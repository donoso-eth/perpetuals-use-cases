...
import { getTimeStampNow } from "../utils";
...
describe("PerpMock contract tests", function () {
    ...
    let storage = {
     ...
     let  lensGelatoW3f = w3f.get("lensChatGPT");
      ...
      await perpMock
        ...
        .updatePrice(priceUpdateData, [1, 2]);
  ...
  it("PerpMock.updatePrice: onlyGelatoMsgSender", async () => {
    ...
    await expect(perpMock.updatePrice(priceUpdateData, [])).to.be.revertedWith(
